"""Inline markup: *emphasis*, **strong**, `code`, [links](href) and backslash
escapes (docs/syntax.md)."""

from .nodes import Code, Emph, Link, Strong, Text
...
def plain_text(nodes):
    """Text content, link text included."""
    out = []
    for n in nodes:
